        ...
        <div class="adres_content">
            ...
            if (!empty($customer_adres_data)) {
                foreach ($customer_adres_data as $data) {
                    ...
                    $col[] = [
                        ...
                        [
                            ...
                            "attributes" => [
                                "class" => "form-control",
                                "type" => "text",
                                "data-component_name" => "block_adres_company",
                    ...
                    $row[] = $col;
                    $template[] = $row;
                    echo '<input type="hidden" data-block_adres_company data-json="' . base64_encode(json_encode($template)) . '"/>';
                }
            }
            $col = [];
            $row = [];
            ...
            echo '<input type="hidden" reset-block_adres_company data-json="' . base64_encode(json_encode($resettemplate)) . '"/>';
            ?>
        </div>
    </div>
</div>
