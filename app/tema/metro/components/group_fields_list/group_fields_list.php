 ...
 * @author engin
 */
class group_fields_list extends component {

    public function render($parameter) {
        $this->set_component_name("group_fields_list");
    ...
    public function loadAction() {
        ...
        if (session::exists(CURRENT_USER_SESSION_NAME)) {
            if ($_REQUEST) {
                ...
                $nview = new view();
                component::import_component("group_fields_list", ["type" => "admin"], true);
                ...
                $data["content"] = $content["group_fields_list"];
