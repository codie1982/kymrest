 ...
 * @author engin
 */
class group_fields_modal extends component {

    public function render($parameter) {
        $this->set_component_name("group_fields_modal");
    ...
    public function loadAction() {
        ...
        if (session::exists(CURRENT_USER_SESSION_NAME)) {
            if ($_REQUEST) {
                ...
                component::add_props(
                        [
                            "group_fields_form" => $content["group_fields_form"],
                        ]
                );
                ...
                $data["content"] = $content["group_fields_modal"];
