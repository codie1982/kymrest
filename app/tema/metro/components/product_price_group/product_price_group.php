 ...
 * @author engin
 */
class product_price_group extends component {

    public function render($parameter) {
        $this->set_component_name("product_price_group");
    ...
    public function loadAction() {
        ...
        if (session::exists(CURRENT_USER_SESSION_NAME)) {
            if ($_REQUEST) {
                ...
                component::import_component("product_price_group", ["type" => "admin"], true);
                ...
                $data["content"] = $content["product_price_group"];
                $data["sonuc"] = true;
