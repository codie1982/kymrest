...
<div data-section="phone">
    <div class="form-group">
        ...
        <div class="phone_content">
                ...
                foreach ($customer_phone_data as $data) {
                    ...
                    $col[] = [
                        ...
                        "content" => [
                            ...
                            "attributes" => [
                                "class" => "form-control",
                                "data-component_name" => "block_phone_company",
                                "data-type" => "area_code",
                            ]
                        ]
                    ]; // Alan Kodu 
                    ...
                    echo '<input type="hidden" data-block_phone_company data-json="' . base64_encode(json_encode($template)) . '"/>';
                }
            }
            ...
            echo '<input type="hidden" reset-block_phone_company data-json="' . base64_encode(json_encode($resettemplate)) . '"/>';
            ?>
        </div>
    </div>
</div>
