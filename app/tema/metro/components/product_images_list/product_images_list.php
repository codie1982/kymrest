 ...
 * @author engin
 */
class product_images_list extends component {

    public function render($parameter) {
        $this->set_component_name("product_images_list");
        $this->make_component($parameter["type"]);
    }

    public function new_product_image_listAction() {
        $data = [];
        ...
        if (session::exists(CURRENT_USER_SESSION_NAME)) {
            if ($_REQUEST) {
                ...
                if (!empty($image_info)) {
                    ...
                    component::import_component("product_images_list", ["type" => "admin"], true);
                    ...
                    $data["content"] = $content["product_images_list"];
                    $data["addtype"] = "append";
                    $data["sonuc"] = true;
