        ...
        <div class="email_content">
            ...
            if (!empty($customer_email_data)) {
                foreach ($customer_email_data as $data) {
                    ...
                    $col[] = [
                        ...
                        [
                            ...
                            "attributes" => [
                                "class" => "form-control",
                                "type" => "text",
                                "data-component_name" => "block_email_company",
                    ...
                    $row[] = $col;
                    $template[] = $row;
                    echo '<input type="hidden" data-block_email_company data-json="' . base64_encode(json_encode($template)) . '"/>';
                }
            }
            $rtemplate = [];
            $col = [];
            ...
            $row[] = $col;
            $rtemplate[] = $row;
            echo '<input type="hidden" reset-block_email_company data-json="' . base64_encode(json_encode($rtemplate)) . '"/>';
            ?>
        </div>
    </div>
</div>
