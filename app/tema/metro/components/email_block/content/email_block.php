<?php component::start(); ?>
<?php $customer_email_data = component::get_props("email_data"); ?>
        ...
        <div class="email_content">
            ...
            if (!empty($customer_email_data)) {
                foreach ($customer_email_data as $data) {
                    ...
                    $col[] = [
                        ...
                        [
                            ...
                            "attributes" => [
                                "class" => "form-control",
                                "type" => "text",
                                "data-component_name" => "personel_email_block",
                    ...
                    $row[] = $col;
                    $template[] = $row;
                    echo '<input type="hidden" data-personel_email_block data-json="' . base64_encode(json_encode($template)) . '"/>';
                }
            }
            $rtemplate = [];
            $col = [];
            ...
            $row[] = $col;
            $rtemplate[] = $row;
            echo '<input type="hidden" reset-personel_email_block data-json="' . base64_encode(json_encode($rtemplate)) . '"/>';
            ?>
        </div>
    </div>
</div>
