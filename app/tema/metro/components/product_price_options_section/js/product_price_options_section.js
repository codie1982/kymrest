var product_price_options_section = function () {
    ...
    var add_group = (e) => {
        e.preventDefault()
        $('[data-product_options_group="add_group"]').on("click", function () {
...
jQuery(document).ready(function () {
    product_price_options_section.init(); // init metronic core componets
});