 ...
 * @author engin
 */
class product_price_options_section extends component {

    public function render($parameter) {
        $this->set_component_name("product_price_options_section");
        $this->make_component($parameter["type"]);
    }

    public function new_product_price_options_sectionAction() {
        $data = [];
        ...
        if (session::exists(CURRENT_USER_SESSION_NAME)) {
            if ($_REQUEST) {
                ...
                component::import_component("product_price_options_section", ["type" => "admin"], true);
                ...
                $data["content"] = $content["product_price_options_section"];
                $data["sonuc"] = true;
