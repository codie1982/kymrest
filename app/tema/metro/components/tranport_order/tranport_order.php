 ...
 * @author engin
 */
class tranport_order extends component {
    ...
    public function render($parameter) {
        $this->set_component_name("tranport_order");
    ...
    public function drawAction() {
        ...
        if (session::exists(CURRENT_USER_SESSION_NAME)) {
            if ($_POST) {
                ...
                $ntable->set_control_class("tranport_order_class");
                ...
                $data["component_name"] = "tranport_order";
                $data["render"] = $table;
