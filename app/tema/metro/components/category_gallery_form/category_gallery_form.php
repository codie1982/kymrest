 ...
 * @author engin
 */
class category_gallery_form extends component {
    ...
    public function render($parameter) {
        $this->set_component_name("category_gallery_form");
    ...
    public function loadAction() {
        ...
        if (session::exists(CURRENT_USER_SESSION_NAME)) {
            if ($_REQUEST) {
                ...
                $ncategory_gallery = new table_category_gallery();
                $category_gallery_data = $ncategory_gallery->get_data_main_key($category_id);

                component::add_props(
                        [
                            "category_gallery_data" => $category_gallery_data,
                        ]
                );
...
//*****************
                ...
                component::add_props(
                        [
                            "category_gallery_images_component" => $content["category_gallery_images"],
                        ]
                );
//*********************
                ...
                component::add_props(
                        [
                            "category_images_list_component" => $content["category_images_list"],
                        ]
                );
//*********************

                component::import_component("category_gallery_form", ["type" => "admin"], true);
                $nview->add_page(component::get_component_module());
                ...
                $data["content"] = $content["category_gallery_form"];
