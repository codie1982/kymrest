 ...
 * @author engin
 */
class complete_order extends component {
    ...
    public function render($parameter) {
        $this->set_component_name("complete_order");
    ...
    public function drawAction() {
        ...
        if (session::exists(CURRENT_USER_SESSION_NAME)) {
            if ($_POST) {
                ...
                $ntable->set_control_class("complete_order_class");
                ...
                $data["component_name"] = "complete_order";
                $data["render"] = $table;
