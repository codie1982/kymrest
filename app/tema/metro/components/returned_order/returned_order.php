 ...
 * @author engin
 */
class returned_order extends component {

    public function render($parameter) {
        $this->set_component_name("returned_order");
    ...
    public function drawAction() {
        ...
        if (session::exists(CURRENT_USER_SESSION_NAME)) {
            if ($_POST) {
                ...
                $ntable->set_control_class("returned_order_class");
                ...
                $data["component_name"] = "returned_order";
                $data["render"] = $table;
