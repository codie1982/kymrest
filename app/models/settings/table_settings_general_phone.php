 ...
 * @author engin
 */
class table_settings_general_phone extends general {


    public function __construct($table = "") {
        $this->selecttable = "settings_general_phone";
...
//    }
    ...
    public function get_general_settings_phone() {
...
//    }
    ...
    public function get_general_settings_phone_from_id($settings_general_phone_id) {
        if ($r = $this->query("SELECT * FROM $this->selecttable WHERE settings_general_phone_id=?", [$settings_general_phone_id])->one()) {
            $r->primary_key = $this->selecttable . "_id";
            return $r;
        } else {
            return false;
