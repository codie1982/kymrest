 ...
 * @author engin
 */
class table_settings_general_adres extends general {


    public function __construct($table = "") {
        $this->selecttable = "settings_general_adres";
...
//    }
    ...
    public function get_general_settings_adres_form_id($settings_general_adres_id) {
        if ($r = $this->query("SELECT * FROM $this->selecttable WHERE settings_general_adres_id = ?", [$settings_general_adres_id])->one()) {
...
//    }
    ...
    public function get_general_settings_adres() {
